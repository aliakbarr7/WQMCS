...
//   Serial.println("Sensor DO    : " + String((float(readDO(ADC_Voltage, Temperaturet)) / 1000)+1.35));
...
//     }
//     else if (LCD_Count == 2) {
//       lcdPrint("O R P  :" + String ((int)orpppm) + "  ppm", "DO     :" + String((float(readDO(ADC_Voltage, Temperaturet)) / 1000)+1.35) + " ppm", "NO3-   :" + String (NO3Val) + " ppm", "pH     :" + String() + (Po) + " pH");
//       LCD_Count = 3;
//     }
//     else if (LCD_Count == 3) {
